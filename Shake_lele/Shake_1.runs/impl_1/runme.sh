...
HD_PWD='C:/Users/Administrator/Desktop/Shake_3/Shake_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Gyro_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Gyro_top.tcl -notrace
