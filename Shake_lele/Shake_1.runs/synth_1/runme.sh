...
HD_PWD='C:/Users/Administrator/Desktop/Shake_3/Shake_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Gyro_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Gyro_top.tcl
